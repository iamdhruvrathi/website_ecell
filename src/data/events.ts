export const events = [
  {
        "_comment": "This needs to be reviewed and must probably be deleted because there was no such event",
        "id": 0,
        "title": "StartUp Conclave 2025",
        "description": "Annual flagship event featuring industry leaders, investors, and successful entrepreneurs sharing insights on building sustainable startups.",
        "date": "2025-11-15",
        ...
        "fullDescription": "Join us for our biggest event of the year where we bring together the brightest minds in entrepreneurship. Network with investors, learn from successful founders, and pitch your ideas to a panel of experts."
    },
    {
        "id": 1,
    ...
    {
        "id": 14,
        "title": "Marketing Ads Competition",
    ...
    {
        "id": 16,
        "title": "Investment Awareness Program",
    ...
    {
        "id": 18,
        "title": "Start-Up to Win 3.0",
        "description": "Upcoming 3 day entrepreneurship workshop led by Mr. B.V. Jagadeesh and alumni entrepreneurs",
        "date": "TBA",
        "venue": "Senate Hall, UVCE",
        "image": null,
        "type": "upcoming",
        "registrationLink": "https://bit.ly/E-Cell_StartUp_To_Win",
    ...
    {
        "id": 19,
        "title": "E-Cell X AlphaGrep: National Level Algo-Trading Hackathon at UVCE",
        "description": "Rapid problem-solving challenge focused on creative thinking with limited resources.",
        "date": "2024-08-30",
        "venue": "",
        "image": null,
        "type": "past",
        "registrationLink": "",
        "fullDescription": "On August 30th, UVCE's E-Cell partnered with AlphaGrep, a leading algo-trading company,to host a National Level Hackathon. Selected colleges from across India participated, with UVCE among the chosen few. The hackathon focused on building algorithmic trading strategies using APIs and various programming languages. Participants developed automated trading systems that integrated real-time data and risk management techniques.\n AlphaGrep also conducted a hands-on workshop, covering key topics such as financial markets, automated trading, and programming applications for algo-trading.\n This collaboration offered UVCE students a unique opportunity to gain practical insights into the rapidly growing field of algorithmic trading, enhancing both their technical and financial skills."
    }
];
